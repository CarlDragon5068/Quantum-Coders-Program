...
def title_screen(screen):
    ...
    restart1_btn = UIElement(
            ...
            bg_rgb=BLUE,
            text_rgb=WHITE,
            text="NASA has spotted incoming alien species,",
        )
    restart2_btn = UIElement(
            ...
            bg_rgb=BLUE,
            text_rgb=WHITE,
            text="they have come to conquer Earth's resources.",
        )
    restart3_btn = UIElement(
            ...
            bg_rgb=BLUE,
            text_rgb=WHITE,
            text="They ran out of resources at their home planet, which scientists call 'Planet X'",
        )
    ...
    restart6_btn = UIElement(
            ...
            bg_rgb=BLUE,
            text_rgb=WHITE,
            text="are forced to fight the incoming hordes of invasion.",
        )
...
while n<2:
    ...
    pygame.display.set_caption("2060")
    ...
    def game_over_text():
        ...
        def title_screen(screen):
            ...
            buttons = [ quit_btn, information_btn, restart_btn ]
